...
compile('api/', ['api/contact.ts', 'api/verify-phone.ts', 'api/newsletter.ts', 'api/newsletter-confirm.ts', 'api/newsletter-prefs.ts', 'api/push-subscribe.ts', 'api/push-send.ts', 'api/search-log.ts', 'api/admin.ts', 'api/changelog.ts', 'api/_origin.ts', 'api/_alert.ts'], 'api', path.join(tmp, 'api'));

      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-pine-900/10 pb-6">
        <div className="space-y-1">
          <div className="inline-flex items-center gap-2 rounded-full border border-gold-500/40 bg-gold-500/10 px-3.5 py-1 text-[11px] font-semibold tracking-wider text-gold-700 uppercase">
            ...
            {isFr ? 'Démonstrateur de scénarios' : 'Scenario demonstrator'}
          </div>
          ...
          <p className="max-w-2xl text-[14px] text-pine-900/75 sm:text-[15px]">
            {isFr
              ? 'Explorez des hypothèses simplifiées de ciblage infranational. Les résultats sont fictifs, non validés et ne constituent pas des recommandations sanitaires.'
              : 'Explore simplified subnational-tailoring assumptions. Outputs are synthetic, unvalidated, and are not health recommendations.'}
          </p>
        </div>
      </div>
      ...
      <div className="mt-10 rounded-2xl border border-gold-500/30 bg-pine-950 p-6 text-white sm:p-8">
        <div className="flex items-center gap-2 text-gold-400">
          ...
          <h3 className="font-display text-lg font-bold tracking-wide uppercase sm:text-xl">
            {isFr ? 'Exemple de paquet généré par le scénario' : 'Example package generated by the scenario'}
          </h3>
        </div>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <div className="mt-3 inline-flex items-center gap-1 rounded bg-gold-400/20 px-2.5 py-1 text-[11px] font-mono text-gold-200">
              ...
              {selectedArchetype.recommendedPackage.vectorControl.coverageTarget[lang]}
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <div className="mt-3 inline-flex items-center gap-1 rounded bg-gold-400/20 px-2.5 py-1 text-[11px] font-mono text-gold-200">
              <ChevronRight size={12} />
              {selectedArchetype.recommendedPackage.chemoprevention.cycles[lang]}
            </div>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm">
            ...
            <div className="mt-3 inline-flex items-center gap-1 rounded bg-gold-400/20 px-2.5 py-1 text-[11px] font-mono text-gold-200">
              <ChevronRight size={12} />
              {selectedArchetype.recommendedPackage.vaccination.target[lang]}
            </div>
          </div>

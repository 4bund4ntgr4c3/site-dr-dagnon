    ...
    <div className="relative overflow-hidden rounded-2xl border border-pine-900/10 bg-white shadow-card">
      <div className="grid gap-0 lg:grid-cols-[1.35fr_1fr]">
        ...
        <div className="relative bg-pine-50 p-6 sm:p-8">
          ...
          <svg viewBox="0 0 100 104" className="h-auto w-full" aria-hidden="true">
            {/* continent */}
            <path
            ...
            {PROJECTS.map((p) => {
              ...
              return (
                <g
                  ...
                  onClick={() => navigate(localePath(lang, `/projets/${p.slug}`))}
          ...
          <p className="mt-3 text-[11px] leading-relaxed text-pine-900/75">
            ...
            return (
              ...
              >
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="block truncate text-xs text-pine-900/75">{p.location[lang]} · {p.period[lang]}</span>
                </span>

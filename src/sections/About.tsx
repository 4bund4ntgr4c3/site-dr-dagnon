            ...
            {IDENTITY[lang].map((item, i) => {
              ...
              return (
                <Reveal key={item.title} delay={0.1 + i * 0.08}>
                  <div className="group h-full rounded-2xl border border-pine-900/10 bg-white p-6 shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-gold-500/50 hover:shadow-card-hover">
                    ...
                    <h3 className="mt-4 font-display text-[1.15rem] font-semibold text-pine-950">{item.title}</h3>

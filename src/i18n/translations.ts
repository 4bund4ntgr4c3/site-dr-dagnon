...
export const EXPERIENCE: Record<Lang, { role: string; org: string; period: string; current: boolean; text: string }[]> = {
  fr: [
    { role: 'Senior Program Officer — Paludisme / Afrique francophone', org: 'Fondation Gates', period: 'déc. 2020 — aujourd’hui', current: true, text: 'Élabore et pilote les stratégies de mise en œuvre du paludisme et des investissements fondés sur la performance ; instruit les subventions et contrats ; appuie la stratégie, la collaboration, la pérennité et l’engagement des partenaires de terrain.' },
    { role: 'Spécialiste gestion de programme / paludisme', org: 'USAID Bénin — U.S. President’s Malaria Initiative', period: 'nov. 2015 — nov. 2020', current: false, text: 'Pilotage de la planification, de la mise en œuvre, de la coordination et du suivi des programmes paludisme ; appui à la préparation et à la réponse aux épidémies ; gestion des mécanismes G2G et partenaires.' },
    { role: 'Consultant international — Suivi & évaluation', org: 'MSH / SIAPS, Guinée', period: 'oct. — nov. 2015', current: false, text: 'Appui aux activités de suivi-évaluation et à la revue du plan stratégique national de lutte contre le paludisme de la Guinée.' },
    { role: 'Responsable suivi & évaluation', org: 'MCDI / ARM3, Bénin', period: 'nov. 2012 — sept. 2015', current: false, text: 'Direction des systèmes de S&E, enquêtes, audits de qualité des données, suivi basé sur la performance et amélioration des informations paludisme de routine.' },
    { role: 'Spécialiste santé maternelle, néonatale et infantile & vaccination', org: 'URC / PISAF, Bénin', period: 'nov. 2011 — oct. 2012', current: false, text: 'Appui aux activités intégrées de santé familiale, suivi de la stratégie ETAT paludisme, analyse de la vaccination et formation des agents de santé.' },
    { role: 'Moniteur d’essais cliniques', org: 'CERHHUD / AUDOBEM-AFRO', period: 'janv. 2008 — juil. 2010', current: false, text: 'Collecte et assurance qualité des données épidémiologiques de 15 hôpitaux ; appui aux audits cliniques et à la formation en soins obstétricaux d’urgence.' },
  ],
  en: [
    { role: 'Senior Program Officer — Malaria / Francophone Africa', org: 'Gates Foundation', period: 'Dec. 2020 — present', current: true, text: 'Designs and leads malaria implementation strategies and performance-based investments; reviews grants and contracts; supports strategy, collaboration, sustainability and field partner engagement.' },
    { role: 'Program Management / Malaria Specialist', org: 'USAID Benin — U.S. President’s Malaria Initiative', period: 'Nov. 2015 — Nov. 2020', current: false, text: 'Leads planning, implementation, coordination and monitoring of malaria programs; supports outbreak preparedness and response; manages G2G mechanisms and partners.' },
    { role: 'International Consultant — Monitoring & Evaluation', org: 'MSH / SIAPS, Guinea', period: 'Oct. — Nov. 2015', current: false, text: 'Supports M&E activities and the review of Guinea’s national strategic malaria control plan.' },
    { role: 'Monitoring & Evaluation Lead', org: 'MCDI / ARM3, Benin', period: 'Nov. 2012 — Sept. 2015', current: false, text: 'Heads M&E systems, surveys, data quality audits, performance-based monitoring and improvement of routine malaria information.' },
    { role: 'Maternal, Newborn, Child Health & Immunization Specialist', org: 'URC / PISAF, Benin', period: 'Nov. 2011 — Oct. 2012', current: false, text: 'Supports integrated family health activities, malaria IPTp strategy monitoring, immunization analysis and health worker training.' },
    { role: 'Clinical Trials Monitor', org: 'CERHHUD / AUDOBEM-AFRO', period: 'Jan. 2008 — Jul. 2010', current: false, text: 'Collects and assures quality of epidemiological data from 15 hospitals; supports clinical audits and emergency obstetric care training.' },
  ],
};
...
export const ACHIEVEMENTS: Record<Lang, { metric: string; title: string; text: string }[]> = {
  fr: [
    ...
    { metric: '200 000 $', title: 'Économies pour le Gouvernement américain', text: 'À l’USAID/PMI Bénin, négociation d’un contrat de gouvernement à gouvernement avec le Programme national de lutte contre le paludisme du Bénin.' },
  ...
  en: [
    ...
    { metric: '$200,000', title: 'Savings for the U.S. Government', text: 'At USAID/PMI Benin, negotiated a government-to-government contract with Benin’s National Malaria Control Program.' },
...
export const UI: Record<Lang, Dict> = {
  ...
  en: {
    ...
    'hero.name': 'Seynudé Jean-Fortuné DAGNON, PhD',

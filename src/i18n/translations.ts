...
export const TRAINING_LIST: Record<Lang, string[]> = {
  fr: [
    'Juin 2023 : Certificat en Science of Defeating Malaria, cours de leadership, Harvard T.H. Chan School of Public Health.',
    'Octobre 2018 \u2013 maintenant : Ph.D. en économie de la santé (en cours), Université de Groningen, Pays-Bas (doctorant externe inscrit en programme à distance). Thèse : coût-efficacité de la pulvérisation intradomiciliaire dans la réduction du fardeau du paludisme au nord du Bénin.',
    'Octobre 2020 : Certificat de connaissance en anglais niveau B2 du CECR (TEFL B2), Centre Beninois de Langues Étrangères (CE.BE.LA.E. \u2013 UAC).',
    'Mars à mai 2020 : Defeating Malaria from the Gene to the Globe, Harvard T.H. Chan School of Public Health.',
    'Août 2019 : Formation AOR/COR (Agreement/Contracting Officer Representative) renforcée, USAID University, Bangkok, Thaïlande.',
    'Novembre 2017 : Conception et gestion de projets, USAID University, Washington, D.C.',
    'Mai 2017 : Conformité environnementale, conception et gestion de projets, USAID University, Harare, Zimbabwe.',
    'Novembre 2016 : Global Acquisition and Assistance System (GLAAS), USAID University, Washington, D.C., USA.',
    'Septembre 2016 : Formation AOR/COR (Agreement/Contracting Officer Representative), USAID University, Washington, D.C., USA.',
    'Août 2016 : Rédaction avancée en anglais, USAID University, Accra, Ghana.',
    'Janvier 2016 : Programmation de l\u2019aide étrangère avec le gouvernement des États-Unis, USAID University, Accra, Ghana.',
    'Décembre 2015 : Genre 101 : Égalité des genres à USAID, USAID University.',
    'Octobre 2012 : Certificat \u00ab Utilisation des données pour les gestionnaires de programmes \u00bb et \u00ab Fondamentaux de l\u2019évaluation \u00bb, USAID et Johns Hopkins Bloomberg School of Public Health.',
    'Juillet 2011 : Master en santé publique (option santé reproductive), Institut de Médecine Tropicale Prince Léopold, Anvers, Belgique.',
    'Mars 2011 : Introduction aux principes et pratiques de la recherche clinique, Clinical Centre, National Institutes of Health (NIH, USA).',
    'Mars 2011 : Certificat de niveau d\u2019anglais 2, Communauté flamande, Département de l\u2019Éducation, Belgique.',
    'Septembre 2009 : Méthodologie de la recherche en VIH et santé reproductive, IRSS Burkina Faso.',
    'Avril 2009 : Cours Stata 9, Centre Muraz, Burkina-Faso, London School of Hygiene and Tropical Medicine.',
    'Décembre 2009 : Certificat de compétence en anglais niveau 2, Centre Beninois de Langues Étrangères (CEBELAE).',
    '2001\u20132007 : Doctorat en médecine générale, Université de Conakry, Guinée.',
  ],
  en: [
    'June 2023: Certificate in Science of Defeating Malaria, a leadership course, Harvard T.H. Chan School of Public Health.',
    'From October 2018 to now: Ph.D. in health economics (underway) at Groningen University in the Netherlands (as an external Ph.D. student enrolled in a distance program). Thesis: Cost-effectiveness of Indoor Residual Spraying in reducing the malaria burden in Northern Benin, West Africa.',
    'October 2020: Certificate of Knowledge in English Language level B2 of CECR (TEFL B2) at University of Abomey-Calavi, Beninese Centre of Foreign Languages (CE.BE.LA.E. \u2013 UAC).',
    'From March to May 2020: Defeating Malaria from the Gene to the Globe at Harvard T.H. Chan School of Public Health.',
    'August 2019: Enhanced Agreement/Contracting Officer Representative (AOR/COR) training by USAID University in Bangkok, Thailand.',
    'November 2017: Project Design and Management by USAID University in Washington, D.C.',
    'May 2017: Environmental Compliance, Sound Design in the Project, and Management in Project Implementation by USAID University in Harare, Zimbabwe.',
    'November 2016: Global Acquisition and Assistance System (GLAAS) training by USAID University in Washington, D.C., USA.',
    'September 2016: Agreement/Contracting Officer Representative (AOR/COR) training by USAID University in Washington, D.C., USA.',
    'August 2016: Advanced English Writing Proficiency by USAID University in Accra, Ghana.',
    'January 2016: Programming Foreign Assistance with the US Government by USAID University in Accra, Ghana.',
    'December 2015: Gender 101: Gender Equality at USAID, by USAID University.',
    'October 2012: Certificate of course completion \u201cData Use for Program Manager\u201d and \u201cMonitoring and Evaluation Fundamentals\u201d delivered by USAID and Johns Hopkins Bloomberg School of Public Health.',
    'July 2011: Master\u2019s in Public Health (Option Reproductive Health) at Prince Leopold Institute of Tropical Medicine \u2013 Antwerp, Belgium.',
    'March 2011: Introduction to Principles and Practice of Clinical Research by Clinical Centre of the National Institutes of Health (NIH, USA).',
    'March 2011: Certificate of English Level 2, Flemish Community, Department of Education, Belgium.',
    'September 2009: Methodology of Research in HIV and Reproductive Health, IRSS Burkina Faso.',
    'April 2009: Stata 9 course at Centre Muraz, Burkina-Faso, provided by the London School of Hygiene and Tropical Medicine.',
    'December 2009: Certificate of English Language Skill Level 2 (by Centre Beninois de Langues Étrangères CEBELAE).',
    '2001\u20132007: Doctorate in General Medicine, University of Conakry, Guinea.',
  ],
};
...
export const UI: Record<Lang, Dict> = {
  ...
  en: {
    ...
    'contact.seoTitle': 'Contact — Seynudé Jean-Fortuné DAGNON, MD, MPH',
    ...
    'pubPage.seoTitle': 'Publications — Seynudé Jean-Fortuné DAGNON, MD, MPH',

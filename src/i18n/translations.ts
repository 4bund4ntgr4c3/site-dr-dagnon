...
export const UI: Record<Lang, Dict> = {
  fr: {
    ...
    'contact.revealHint': 'Envoyez votre message pour révéler les coordonnées.',
    'contact.locked': 'Masqué',
  ...
  en: {
    ...
    'contact.revealHint': 'Send your message to reveal the contact details.',

...
export const UI: Record<Lang, Dict> = {
  fr: {
    ...
    'contact.formText': 'Remplissez le formulaire ci-dessous — réponse sous 48 h.',
  ...
  en: {
    ...
    'contact.formText': 'Fill in the form below — response within 48 h.',

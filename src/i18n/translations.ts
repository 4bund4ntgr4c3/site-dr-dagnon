...
export const ACHIEVEMENTS: Record<Lang, { metric: string; title: string; text: string }[]> = {
  fr: [
    ...
    { metric: '200 000 $', title: 'Économies gouvernementales majeures', text: 'À l’USAID/PMI Bénin, négociation d’un contrat de gouvernement à gouvernement avec le Programme national de lutte contre le paludisme du Bénin, générant des économies allant jusqu’à 3 000 000 $ sur 5 ans.' },
  ...
  en: [
    ...
    { metric: '$200,000', title: 'Major government savings', text: 'At USAID/PMI Benin, negotiated a government-to-government contract with Benin’s National Malaria Control Program, generating savings of up to $3,000,000 over 5 years.' },

...
import { Scale, Server, ShieldCheck, Cookie, UserCheck, Copyright, ArrowUpRight } from 'lucide-react';
import { Reveal } from '@/components/Reveal';
import { useLang } from '@/i18n/useLang';
import { UI } from '@/i18n/translations';
import { localePath } from '@/i18n/routing';
import { LEGAL_SECTIONS, LEGAL_LAST_UPDATED } from '@/data/legal';

const SECTION_ICONS = [Scale, Server, ShieldCheck, Cookie, UserCheck, Copyright];

...
export default function Contact() {
  ...
  /* the number is only known after verification (it never ships in the
     bundle), so the WhatsApp link follows the same gates as the phone card */
  const waNumber = phone ? `https://wa.me/${phone.split(' - ')[0].replace(/\D/g, '')}` : '';

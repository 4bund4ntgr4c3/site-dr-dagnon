...
export const IMPACT_STATS: Record<Lang, ImpactStat[]> = {
  fr: [
    ...
    { value: 'Plusieurs dizaines de M$', label: { fr: 'de portefeuille géré', en: 'in portfolio managed' }, detail: { fr: 'Subventions et contrats supervisés à la Fondation Gates.', en: 'Grants and contracts overseen at the Gates Foundation.' } },
  ...
  en: [
    ...
    { value: 'Tens of millions $', label: { fr: 'de portefeuille géré', en: 'in portfolio managed' }, detail: { fr: 'Subventions et contrats supervisés à la Fondation Gates.', en: 'Grants and contracts overseen at the Gates Foundation.' } },
    { value: '34', label: { fr: 'zones de santé couvertes', en: 'health zones covered' }, detail: { fr: 'Approche basée sur la performance et S&E sur l\'ensemble des zones du Bénin (ARM3).', en: 'Performance-based approach and M&E across all of Benin\'s zones (ARM3).' } },
    { value: '78', label: { fr: 'statisticiens formés', en: 'statisticians trained' }, detail: { fr: '44 statisticiens hospitaliers et 34 de zones formés à LOGISNIGS.', en: '44 hospital and 34 health zone statisticians trained on LOGISNIGS.' } },
  ],
};

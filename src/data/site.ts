  ...
  fr: [
    {
      ...
      details: {
        ...
        projects: [
          ...
          { name: 'Kinshasa School of Public Health', scope: 'RDC', budget: '$750 000 (1 an)' },
          { name: 'UCLA — Surveillance sentinelle', scope: 'RDC', budget: '$400 000 (1 an)' },
          { name: 'MIM — Conférence panafricaine 2024', scope: 'Rwanda', budget: '$300 000 (1 an)' },
          { name: 'Évaluation initiale PNLP', scope: 'Cameroun', budget: '$96 000 (1 an)' },
        ],
    ...
    },
    {
      ...
      details: {
        ...
        projects: [
          ...
          { name: 'AIRS (Manager)', scope: 'Abt Associates', budget: '$4 200 000 (3 ans)' },
  ...
  en: [
    {
      ...
      details: {
        ...
        projects: [
          ...
          { name: 'Kinshasa School of Public Health', scope: 'DRC', budget: '$750,000 (1 yr)' },
          { name: 'UCLA — Sentinel Surveillance', scope: 'DRC', budget: '$400,000 (1 yr)' },
          { name: 'MIM — Pan-African Conference 2024', scope: 'Rwanda', budget: '$300,000 (1 yr)' },
          { name: 'Cameroon NMCP Initial Assessment', scope: 'Cameroon', budget: '$96,000 (1 yr)' },
        ],
    ...
    },
    {
      ...
      period: 'Nov. 2015 — Nov. 2020',
      current: false,
      text: 'Managed a portfolio exceeding US$65M across 10 grants and agreements. Leads planning, implementation, coordination and monitoring of malaria programs; supports outbreak preparedness and response; manages G2G mechanisms and partners.',
      details: {
        responsibilities: [
        ...
        projects: [
          ...
          { name: 'AIRS (Manager)', scope: 'Abt Associates', budget: '$4,200,000 (3 yrs)' },

...
export const PUBLICATIONS: Record<Lang, { title: string; authors: string; journal: string; year: number; url?: string; featured?: boolean }[]> = {
  fr: [
    ...
    { title: 'Du contrôle du paludisme à son élimination : le virage que nous devons prendre', authors: 'Rose Leke, Seynudé Jean Fortune Dagnon', journal: 'Africa Health Watch — Perspectives', year: 2026, url: 'https://africahealthwatch.com/from-malaria-control-to-elimination-the-turn-we-need-to-make/?utm_source=publication-search' },
  ...
  en: [
    ...
    { title: 'From Malaria Control to Elimination: The Turn We Need to Make', authors: 'Rose Leke, Seynudé Jean Fortune Dagnon', journal: 'Africa Health Watch — Perspectives', year: 2026, url: 'https://africahealthwatch.com/from-malaria-control-to-elimination-the-turn-we-need-to-make/?utm_source=publication-search' },

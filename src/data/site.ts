...
export const STATS: Record<Lang, StatItem[]> = {
  fr: [
    { value: 20, suffix: '+', label: "années d'expérience", detail: 'Programmes paludisme, VIH/SIDA, NTN et santé MNI à travers l’Afrique' },
    { displayValue: 'Plusieurs dizaines de M$', label: 'de portefeuille géré', detail: 'Subventions et investissements supervisés à travers l’Afrique' },
  ...
  en: [
    ...
    { displayValue: 'Tens of millions $', label: 'in portfolio managed', detail: 'Grant portfolios and strategic investments across Africa' },
...
export const IDENTITY: Record<Lang, { title: string; text: string; icon: string }[]> = {
  fr: [
    { title: 'Rôle actuel', text: 'Senior Program Officer à la Fondation Gates — portefeuille de subventions de plusieurs dizaines de millions de dollars sur 15 pays.', icon: 'briefcase' },
  ...
  en: [
    { title: 'Current role', text: 'Senior Program Officer at the Gates Foundation — grant portfolios of several tens of millions of dollars across 15 countries.', icon: 'briefcase' },
...
export const EXPERTISE: Record<Lang, { title: string; text: string; icon: string }[]> = {
  fr: [
    { title: 'Stratégie d’investissement & pilotage de portefeuille', text: 'Pilotage de portefeuilles de subventions de plusieurs dizaines de millions de dollars — structuration et suivi d’accords complexes fondés sur la performance dans 15 pays.', icon: 'layers' },
  ...
  en: [
    { title: 'Investment Strategy & Portfolio Leadership', text: 'Steering grant portfolios of several tens of millions of dollars — structuring and overseeing complex performance-based agreements across 15 countries.', icon: 'layers' },
  ...
  fr: [
    {
      ...
      details: {
        ...
        projects: [
          { name: 'CRS — Digitalisation MILDA', scope: 'Bénin', budget: '3 ans' },
          { name: 'CRS — Plateforme intégrée', scope: 'Bénin', budget: '3 ans' },
          { name: 'MSH — Recherche CPS', scope: 'Bénin', budget: '2 ans' },
          { name: 'Zenysis — Plateforme interopérabilité', scope: 'Bénin', budget: '1 an' },
          { name: 'Muso Inc — Biomarqueurs résistance', scope: 'Mali', budget: '3 ans' },
          { name: 'Alliance Malaria Prevention', scope: 'Genève', budget: '6 ans' },
          { name: 'LSHTM — Efficacité CPS', scope: 'Burkina Faso', budget: '3 ans' },
          { name: 'PSI — Marché paludisme', scope: 'Bénin, Nigéria, Cameroun', budget: '3 ans' },
          { name: 'EBOLA', scope: 'RDC, Sénégal, Gambie, RCA', budget: 'Multi-pays' },
          { name: 'CHAI Malaria Grant', scope: 'RDC, Cameroun, Bénin, Burkina Faso', budget: 'Multi-pays' },
          { name: 'ENABEL', scope: 'Burundi, Niger', budget: '6 ans' },
          { name: 'Harvard — Science of Defeating Malaria', scope: 'USA', budget: '1 an' },
          { name: 'Kinshasa School of Public Health', scope: 'RDC', budget: '1 an' },
          { name: 'UCLA — Surveillance sentinelle', scope: 'RDC', budget: '1 an' },
          { name: 'MIM — Conférence panafricaine 2024', scope: 'Rwanda', budget: '1 an' },
          { name: 'Évaluation initiale PNLP', scope: 'Cameroun', budget: '1 an' },
        ],
        achievement: 'Triplement du financement national du Bénin pour le paludisme ; déploiement des plateformes IA RedRose et DIGITHCM pour les campagnes MILDA ; toolkit ACTwatch Lite ; professionnalisation du secrétariat MIM ; et réponse d\'urgence 2026 en RDC (Ebola & MDA paludisme).',
      },
    },
    {
      ...
      details: {
        ...
        projects: [
          { name: 'ARM3 (AOR)', scope: 'Bénin', budget: '6 ans' },
          { name: 'DINDJI HIV (AOR)', scope: 'Bénin', budget: '3 ans' },
          { name: 'Ebola (AOR)', scope: 'Bénin', budget: '2 ans' },
          { name: 'IL 19, 27, 29 (GATR)', scope: 'PNLP Bénin', budget: '3 ans' },
          { name: 'IL 25, 32-34 (GATR)', scope: 'PNLP Bénin', budget: '3 ans' },
          { name: 'IL 24, 26, 31, 33 (GATR)', scope: 'CREC Bénin', budget: '3 ans' },
          { name: 'AIRS (Manager)', scope: 'Abt Associates', budget: '3 ans' },
          { name: 'CATCH (Manager)', scope: 'CRS', budget: '3 ans' },
          { name: 'ENVISION (Manager)', scope: 'RTI', budget: '7 ans' },
          { name: 'ACT END NTDs (Manager)', scope: 'FHI 360', budget: '5 ans' },
        ],
    ...
    },
    {
      ...
      org: 'Cabinet Best-SD, Bénin',
      period: 'août — oct. 2011',
      current: false,
      text: 'Évaluation de la politique de gratuité de la césarienne et du Fonds des indigents pour le Ministère de la Santé ; évaluation de la gestion des risques du Fonds mondial pour 6 récipiendaires principaux locaux.',
      details: {
        responsibilities: [
          'Évaluer la mise en œuvre de la gratuité de la césarienne et du Fonds des indigents au Bénin',
          'Conduire l\'évaluation de la gestion des risques du Fonds mondial auprès de 6 récipiendaires principaux locaux',
          'Analyser les données financières, programmatiques et de gouvernance des structures évaluées',
        ],
      },
    },
    {
    ...
    {
      role: 'Médecin en pédiatrie',
      org: 'Hôpital Saint-Luc & Clinique les Cocotiers, Bénin',
      period: 'oct. — déc. 2007',
      current: false,
      text: 'Pratique clinique précoce en médecine pédiatrique : consultations, hospitalisations et prise en charge des urgences pédiatriques et néonatales.',
      details: {
        responsibilities: [
          'Assurer les consultations pédiatriques et le suivi des enfants hospitalisés',
          'Prise en charge des urgences pédiatriques et néonatales',
          'Conseil aux familles et suivi nutritionnel et vaccinal',
        ],
      },
    },
  ],
  en: [
    {
      ...
      current: true,
      text: 'Direct management and technical oversight of grant portfolios totaling several tens of millions of dollars across 15 Sub-Saharan African countries. Designs and leads malaria implementation strategies and performance-based investments; reviews grants and contracts; supports strategy, collaboration, sustainability and field partner engagement.',
      details: {
        responsibilities: [
          'Lead direct management and technical oversight of grant portfolios totaling several tens of millions of dollars across 15 countries',
        ...
        projects: [
          { name: 'CRS — LLIN Digitization', scope: 'Benin', budget: '3 yrs' },
          { name: 'CRS — Integrated Platform', scope: 'Benin', budget: '3 yrs' },
          { name: 'MSH — SMC Research', scope: 'Benin', budget: '2 yrs' },
          { name: 'Zenysis — Interoperability', scope: 'Benin', budget: '1 yr' },
          { name: 'Muso Inc — Resistance Biomarkers', scope: 'Mali', budget: '3 yrs' },
          { name: 'Alliance Malaria Prevention', scope: 'Geneva', budget: '6 yrs' },
          { name: 'LSHTM — SMC Efficacy', scope: 'Burkina Faso', budget: '3 yrs' },
          { name: 'PSI — Malaria Market', scope: 'Benin, Nigeria, Cameroon', budget: '3 yrs' },
          { name: 'EBOLA', scope: 'DRC, Senegal, Gambia, CAR', budget: 'Multi-country' },
          { name: 'CHAI Malaria Grant', scope: 'DRC, Cameroon, Benin, Burkina Faso', budget: 'Multi-country' },
          { name: 'ENABEL', scope: 'Burundi, Niger', budget: '6 yrs' },
          { name: 'Harvard — Science of Defeating Malaria', scope: 'USA', budget: '1 yr' },
          { name: 'Kinshasa School of Public Health', scope: 'DRC', budget: '1 yr' },
          { name: 'UCLA — Sentinel Surveillance', scope: 'DRC', budget: '1 yr' },
          { name: 'MIM — Pan-African Conference 2024', scope: 'Rwanda', budget: '1 yr' },
          { name: 'Cameroon NMCP Initial Assessment', scope: 'Cameroon', budget: '1 yr' },
        ],
        achievement: 'Tripled Benin domestic malaria financing; rolled out RedRose and DIGITHCM AI platforms for LLIN campaigns; developed ACTwatch Lite toolkit; professionalized MIM secretariat; and led 2026 DRC emergency response (Ebola & malaria MDA).',
      },
    },
    {
      role: 'Program Management Specialist, Malaria',
      ...
      period: 'Nov. 2015 — Nov. 2020',
      current: false,
      text: 'Managed a multi-grant portfolio of several tens of millions of dollars across 10 grants and agreements. Leads planning, implementation, coordination and monitoring of malaria programs; supports outbreak preparedness and response; manages G2G mechanisms and partners.',
      details: {
        responsibilities: [
        ...
        projects: [
          { name: 'ARM3 (AOR)', scope: 'Benin', budget: '6 yrs' },
          { name: 'DINDJI HIV (AOR)', scope: 'Benin', budget: '3 yrs' },
          { name: 'Ebola (AOR)', scope: 'Benin', budget: '2 yrs' },
          { name: 'IL 19, 27, 29 (GATR)', scope: 'PNLP Benin', budget: '3 yrs' },
          { name: 'IL 25, 32-34 (GATR)', scope: 'PNLP Benin', budget: '3 yrs' },
          { name: 'IL 24, 26, 31, 33 (GATR)', scope: 'CREC Benin', budget: '3 yrs' },
          { name: 'AIRS (Manager)', scope: 'Abt Associates', budget: '3 yrs' },
          { name: 'CATCH (Manager)', scope: 'CRS', budget: '3 yrs' },
          { name: 'ENVISION (Manager)', scope: 'RTI', budget: '7 yrs' },
          { name: 'ACT END NTDs (Manager)', scope: 'FHI 360', budget: '5 yrs' },
        ],
    ...
    },
    {
      ...
      org: 'Cabinet Best-SD, Benin',
      period: 'Aug. — Oct. 2011',
      current: false,
      text: 'Evaluated the national free caesarean section policy and Indigent Fund for the Ministry of Health; conducted Global Fund risk management assessment for 6 local principal recipients.',
      details: {
        responsibilities: [
          'Evaluate implementation of free caesarean section policy and Indigent Fund in Benin',
          'Conduct Global Fund risk management assessment for 6 local principal recipients',
          'Analyze financial, programmatic and governance data across evaluated entities',
        ],
      },
    },
    {
    ...
    {
      role: 'Medical Officer in Pediatrics',
      org: 'Saint-Luc Hospital & Clinique les Cocotiers, Benin',
      period: 'Oct. — Dec. 2007',
      current: false,
      text: 'Early clinical practice in pediatric medicine: outpatient consultations, inpatient care, and management of pediatric and neonatal emergencies.',
      details: {
        responsibilities: [
          'Provide pediatric consultations and inpatient medical care',
          'Manage pediatric and neonatal emergencies',
          'Family counseling on nutrition, growth monitoring, and immunization',
        ],
      },
    },
  ],
...
export const TRAINING_LIST: Record<Lang, { date: string; institution: string; detail: string }[]> = {
  fr: [
    ...
    { date: 'Novembre 2017', institution: 'USAID University, Bangkok, Thaïlande', detail: 'Conception et gestion de projets.' },
    ...
    { date: 'Juillet 2011', institution: 'Institut de Médecine Tropicale Prince Léopold, Anvers, Belgique', detail: 'Master en santé publique (option lutte contre les maladies).' },
  ...
  en: [
    ...
    { date: 'November 2017', institution: 'USAID University, Bangkok, Thailand', detail: 'Project Design and Management.' },
    ...
    { date: 'July 2011', institution: 'Prince Leopold Institute of Tropical Medicine \u2013 Antwerp, Belgium', detail: 'Master\u2019s in Public Health (Option Disease Control).' },
...
export const PUBLICATIONS: Record<Lang, { title: string; authors: string; journal: string; year: number; url?: string; featured?: boolean }[]> = {
  fr: [
    ...
    { title: 'Du contrôle du paludisme à son élimination : le virage que nous devons prendre', authors: 'Rose Leke, Seynudé Jean Fortune Dagnon', journal: 'Africa Health Watch & Le Soleil (Sénégal) — Perspectives', year: 2026, url: 'https://africahealthwatch.com/from-malaria-control-to-elimination-the-turn-we-need-to-make/?utm_source=publication-search' },
  ...
  en: [
    ...
    { title: 'From Malaria Control to Elimination: The Turn We Need to Make', authors: 'Rose Leke, Seynudé Jean Fortune Dagnon', journal: 'Africa Health Watch & Le Soleil (Senegal) — Perspectives', year: 2026, url: 'https://africahealthwatch.com/from-malaria-control-to-elimination-the-turn-we-need-to-make/?utm_source=publication-search' },
